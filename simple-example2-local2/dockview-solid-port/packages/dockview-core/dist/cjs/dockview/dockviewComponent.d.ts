...
import { DockviewDragItemDescriptor, DockviewDragSessionSnapshot, DockviewDragSessionStore } from '../dnd/dragSession';
import { DockviewEnvironmentController, DockviewInteractionMode, DockviewLayoutMode } from './dockviewEnvironment';
...
export declare class DockviewComponent extends BaseGrid<DockviewGroupPanel> implements IDockviewComponent {
    ...
    beginNativeDragSession(item: DockviewDragItemDescriptor, event: DragEvent): void;
    ...
    private updateTheme;
    private updateEnvironmentAttributes;
