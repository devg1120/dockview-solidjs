...
var Tabs = /** @class */ (function (_super) {
    ...
    function Tabs(group, accessor, options) {
        ...
        (0, dom_1.addTestId)(_this._tabsList, 'dockview-tabs-list');
        _this._tabsList.dataset.groupId = _this.group.id;
    ...
    Tabs.prototype.openPanel = function (panel, index) {
        ...
        var disposable = new lifecycle_1.CompositeDisposable(tab.onDragStart(function (event) {
            ...
            _this._onTabContextMenu.fire({ event: event, panel: panel });
    ...
    Tabs.prototype.toggleDropdown = function (options) {
        var _this = this;
        var reset = options.reset || this._tabs.length <= 1;
        var tabs = reset
            ? []
            : this._tabs
                .filter(function (tab) {
        ...
        this._onOverflowTabsChange.fire({ tabs: tabs, reset: reset });
    };
