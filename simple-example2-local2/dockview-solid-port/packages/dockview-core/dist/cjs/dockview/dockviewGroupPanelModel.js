...
var DockviewGroupPanelModel = /** @class */ (function (_super) {
    ...
    function DockviewGroupPanelModel(container, accessor, id, options, groupPanel) {
        ...
        (0, dom_1.addTestId)(_this.container, 'dockview-group');
        _this.container.dataset.groupId = id;
    ...
    DockviewGroupPanelModel.prototype.canDisplayOverlay = function (event, position, target) {
        var firedEvent = new options_1.DockviewUnhandledDragOverEvent(event.nativeEvent, target, position, dataTransfer_1.getPanelData, this.accessor.getPanel(this.id));
    ...
    DockviewGroupPanelModel.prototype.handleDropEvent = function (type, event, position, index) {
        ...
        var willDropEvent = new DockviewWillDropEvent({
            ...
            panel: panel,
            getData: function () {
                return (0, dataTransfer_1.getPanelDataWithNativeFallback)((0, dragSession_1.getDataTransferFromNativeEvent)(event));
            },
            kind: getKind(),
            group: this.groupPanel,
            api: this._api,
        ...
        var data = (0, dataTransfer_1.getPanelDataWithNativeFallback)((0, dragSession_1.getDataTransferFromNativeEvent)(event));
