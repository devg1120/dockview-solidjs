...
import { DockviewDragInteraction, DockviewNativeDragEvent } from '../dnd/dragSession';
...
export interface IDockviewGroupPanelModel extends IPanel {
    ...
    canDisplayOverlay(event: DockviewDragInteraction, position: Position, target: DockviewGroupDropLocation): boolean;
}
