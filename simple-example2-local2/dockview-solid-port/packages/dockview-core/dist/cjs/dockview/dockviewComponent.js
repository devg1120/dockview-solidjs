...
var dragSession_1 = require("../dnd/dragSession");
var dockviewEnvironment_1 = require("./dockviewEnvironment");
var touchDragManager_1 = require("../dnd/touchDragManager");
...
var DockviewComponent = /** @class */ (function (_super) {
    ...
    function DockviewComponent(container, options) {
        ...
        _this.dragSessionStore = new dragSession_1.DockviewDragSessionStore();
        _this.environment = new dockviewEnvironment_1.DockviewEnvironmentController(_this.element);
        _this.touchDragManager = new touchDragManager_1.DockviewTouchDragManager(_this.element, _this.environment, _this.dragSessionStore);
        (0, dom_1.addTestId)(_this.element, 'dockview-root');
        _this.updateEnvironmentAttributes();
        _this.updateDragSessionAttributes(_this.dragSession);
        ...
        _this._rootDropTarget = new droptarget_1.Droptarget(_this.element, {
            ...
            dragSessionStore: _this.dragSessionStore,
            targetDescriptor: {
                kind: 'edge',
            },
            canDisplayOverlay: function (event, position) {
                ...
                if (hasData) {
                    ...
                    if (localData && localData.viewId !== _this.id) {
                        return false;
                    }
                ...
                var firedEvent = new options_1.DockviewUnhandledDragOverEvent(event.nativeEvent, 'edge', position, dataTransfer_1.getPanelData);
        ...
        _this.addDisposables(_this.dragSessionStore, _this.environment, _this.touchDragManager, _this.rootDropTargetContainer, _this.overlayRenderContainer, _this._onWillDragPanel, _this._onWillDragGroup, _this._onWillShowOverlay, _this._onDidActivePanelChange, _this._onDidAddPanel, _this._onDidRemovePanel, _this._onDidLayoutFromJSON, _this._onDidDrop, _this._onWillDrop, _this._onDidMovePanel, _this._onDidAddGroup, _this._onDidRemoveGroup, _this._onDidActiveGroupChange, _this._onUnhandledDragOverEvent, _this._onDidMaximizedGroupChange, _this._onDidOptionsChange, _this._onDidPopoutGroupSizeChange, _this._onDidPopoutGroupPositionChange, _this._onDidOpenPopoutWindowFail, _this.environment.onDidInteractionModeChange(function () {
            _this.updateEnvironmentAttributes();
        }), _this.environment.onDidLayoutModeChange(function () {
            _this.updateEnvironmentAttributes();
        }), _this.dragSessionStore.onDidChange(function (event) {
            _this.updateDragSessionAttributes(event);
            ...
            var willDropEvent = new dockviewGroupPanelModel_1.DockviewWillDropEvent({
                ...
                group: undefined,
                getData: function () {
                    return (0, dataTransfer_1.getPanelDataWithNativeFallback)((0, dragSession_1.getDataTransferFromNativeEvent)(event.nativeEvent));
                },
                kind: 'edge',
            });
            ...
            var data = (0, dataTransfer_1.getPanelDataWithNativeFallback)((0, dragSession_1.getDataTransferFromNativeEvent)(event.nativeEvent));
            if (data) {
    ...
    Object.defineProperty(DockviewComponent.prototype, "interactionMode", {
        get: function () {
    ...
    Object.defineProperty(DockviewComponent.prototype, "layoutMode", {
        get: function () {
    ...
    Object.defineProperty(DockviewComponent.prototype, "dragSession", {
        get: function () {
    ...
    Object.defineProperty(DockviewComponent.prototype, "onDidInteractionModeChange", {
        get: function () {
    ...
    Object.defineProperty(DockviewComponent.prototype, "onDidLayoutModeChange", {
        get: function () {
    ...
    Object.defineProperty(DockviewComponent.prototype, "onDidDragSessionChange", {
        get: function () {
    ...
    DockviewComponent.prototype.beginNativeDragSession = function (item, event) {
    ...
    DockviewComponent.prototype.completeNativeDragSession = function (event) {
    ...
    DockviewComponent.prototype.updateEnvironmentAttributes = function () {
        this.element.dataset.interactionMode = this.interactionMode;
        this.element.dataset.layoutMode = this.layoutMode;
    };
    DockviewComponent.prototype.updateDragSessionAttributes = function (session) {
        var _a, _b;
