...
var DraggablePaneviewPanel = /** @class */ (function (_super) {
    ...
    DraggablePaneviewPanel.prototype.initDragFeatures = function () {
        ...
        this.handler = new (/** @class */ (function (_super) {
            ...
            PaneDragHandler.prototype.getData = function (event) {
                var transfer = new dataTransfer_1.PaneTransfer(accessorId, id);
                return (0, dataTransfer_1.beginPaneTransfer)(transfer, event.dataTransfer);
            };
        ...
        this.target = new droptarget_1.Droptarget(this.element, {
            ...
            canDisplayOverlay: function (event, position) {
                ...
                var firedEvent = new options_1.PaneviewUnhandledDragOverEvent(event.nativeEvent, position, dataTransfer_1.getPaneData, _this);
