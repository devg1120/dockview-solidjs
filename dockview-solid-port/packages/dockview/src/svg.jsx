export function CloseButton() {
    return (<svg height="11" width="11" viewBox="0 0 28 28" aria-hidden="false" class="dv-svg">
...
export function ExpandMore() {
    return (<svg width="11" height="11" viewBox="0 0 24 15" aria-hidden="false" class="dv-svg">
