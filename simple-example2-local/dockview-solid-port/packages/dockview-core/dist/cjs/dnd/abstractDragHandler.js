...
var DragHandler = /** @class */ (function (_super) {
    ...
    function DragHandler(el, disabled) {
        ...
        _this.addDisposables(_this._onDragStart, _this._onDragEnd, _this.dataDisposable, _this.pointerEventsDisposable);
        _this.configure();
        return _this;
    }
    ...
    DragHandler.prototype.configure = function () {
        ...
        }), (0, events_1.addDisposableListener)(this.el, 'dragend', function (event) {
