...
const EMPTY_DOCKVIEW_DRAG_SESSION = {
    sessionId: null,
    backend: null,
    state: 'idle',
};
...
class DockviewDragSessionStore {
    constructor() {
...
class DockviewEnvironmentController extends CompositeDisposable {
    get interactionMode() {
...
class DragHandler extends CompositeDisposable {
    constructor(el, disabled) {
        ...
        this.addDisposables(this._onDragStart, this._onDragEnd, this.dataDisposable, this.pointerEventsDisposable);
        this.configure();
    }
...
class Scrollbar extends CompositeDisposable {
    ...
    constructor(scrollableElement) {
        ...
        }, { passive: true }), addDisposableListener(this._horizontalScrollbar, 'pointerdown', (event) => {
            event.preventDefault();
...
class DockviewGroupPanelModel extends CompositeDisposable {
    ...
    canDisplayOverlay(event, position, target) {
        const firedEvent = new DockviewUnhandledDragOverEvent(event.nativeEvent, target, position, getPanelData, this.accessor.getPanel(this.id));
        this._onUnhandledDragOverEvent.fire(firedEvent);
        return firedEvent.isAccepted;
    }
    handleDropEvent(type, event, position, index) {
        ...
        const willDropEvent = new DockviewWillDropEvent({
            ...
            position,
            panel,
            getData: () => getPanelDataWithNativeFallback(getDataTransferFromNativeEvent(event)),
            kind: getKind(),
            group: this.groupPanel,
            api: this._api,
        });
        ...
        const data = getPanelDataWithNativeFallback(getDataTransferFromNativeEvent(event));
...
class DockviewTouchDragManager extends CompositeDisposable {
...
class DockviewComponent extends BaseGrid {
    ...
    constructor(container, options) {
        ...
        this.touchDragManager = new DockviewTouchDragManager(this.element, this.environment, this.dragSessionStore);
        ...
        this._rootDropTarget = new Droptarget(this.element, {
            ...
            canDisplayOverlay: (event, position) => {
                ...
                const hasData = hasPanelData(event.dataTransfer);
                const localData = getPanelData();
                isCrossWindowDrag(event.dataTransfer);
                if (hasData) {
                ...
                const firedEvent = new DockviewUnhandledDragOverEvent(event.nativeEvent, 'edge', position, getPanelData);
                this._onUnhandledDragOverEvent.fire(firedEvent);
                return firedEvent.isAccepted;
            },
            acceptedTargetZones: ['top', 'bottom', 'left', 'right', 'center'],
        ...
        this.addDisposables(this.dragSessionStore, this.environment, this.touchDragManager, this.rootDropTargetContainer, this.overlayRenderContainer, this._onWillDragPanel, this._onWillDragGroup, this._onWillShowOverlay, this._onDidActivePanelChange, this._onDidAddPanel, this._onDidRemovePanel, this._onDidLayoutFromJSON, this._onDidDrop, this._onWillDrop, this._onDidMovePanel, this._onDidAddGroup, this._onDidRemoveGroup, this._onDidActiveGroupChange, this._onUnhandledDragOverEvent, this._onDidMaximizedGroupChange, this._onDidOptionsChange, this._onDidPopoutGroupSizeChange, this._onDidPopoutGroupPositionChange, this._onDidOpenPopoutWindowFail, this.environment.onDidInteractionModeChange(() => {
            this.updateEnvironmentAttributes();
            ...
            const willDropEvent = new DockviewWillDropEvent({
                ...
                api: this._api,
                group: undefined,
                getData: () => getPanelDataWithNativeFallback(getDataTransferFromNativeEvent(event.nativeEvent)),
                kind: 'edge',
            });
            this._onWillDrop.fire(willDropEvent);
            if (willDropEvent.defaultPrevented) {
            ...
            // Use native fallback for cross-window drag support
            const data = getPanelDataWithNativeFallback(getDataTransferFromNativeEvent(event.nativeEvent));
            if (data) {
    ...
    beginNativeDragSession(item, event) {
        this.dragSessionStore.startDragging({
            backend: 'desktop',
            item,
            coordinates: getDragCoordinates(event),
    ...
    completeNativeDragSession(event) {
    ...
    updateDragSessionAttributes(session) {
        var _a, _b;
        this.element.dataset.dragState = session.state;
        if ((_a = session.item) === null || _a === void 0 ? void 0 : _a.itemType) {
        ...
        if ((_b = session.activeDropTarget) === null || _b === void 0 ? void 0 : _b.kind) {
 ...
 */
class ExternalDetachController {
    constructor(config = {}) {
...
export { BaseGrid, ContentContainer, DOCKVIEW_PANEL_MIME_TYPE, DOCKVIEW_PANE_MIME_TYPE, DefaultDockviewDeserialzier, DefaultTab, DockviewApi, DockviewComponent, CompositeDisposable as DockviewCompositeDisposable, DockviewDidDropEvent, Disposable as DockviewDisposable, DockviewDragSessionStore, Emitter as DockviewEmitter, DockviewEnvironmentController, Event as DockviewEvent, DockviewGroupPanel, DockviewGroupPanelModel, MutableDisposable as DockviewMutableDisposable, DockviewPanel, DockviewUnhandledDragOverEvent, DockviewWillDropEvent, DraggablePaneviewPanel, EMPTY_DOCKVIEW_DRAG_SESSION, ExternalDetachController, Gridview, GridviewApi, GridviewComponent, GridviewPanel, LayoutPriority, Orientation, PROPERTY_KEYS_DOCKVIEW, PROPERTY_KEYS_GRIDVIEW, PROPERTY_KEYS_PANEVIEW, PROPERTY_KEYS_SPLITVIEW, PaneFramework, PaneTransfer, PanelTransfer, Paneview, PaneviewApi, PaneviewComponent, PaneviewPanel, PaneviewUnhandledDragOverEvent, SashState, Sizing, Splitview, SplitviewApi, SplitviewComponent, SplitviewPanel, Tab, beginPaneTransfer, beginPanelTransfer, createDockview, createGridview, createPaneview, createSplitview, detectInteractionMode, detectLayoutModeFromSize, directionToPosition, getDataTransferFromNativeEvent, getDirectionOrientation, getDragCoordinates, getGridLocation, getLocationOrientation, getNativePaneData, getNativePanelData, getPaneData, getPanelData, getPanelDataWithNativeFallback, getRelativeLocation, hasNativePanelData, hasPanelData, indexInParent, isCrossWindowDrag, isGridBranchNode, isGroupOptionsWithGroup, isGroupOptionsWithPanel, isPanelOptionsWithGroup, isPanelOptionsWithPanel, orthogonal, positionToDirection, setNativePaneData, setNativePanelData, themeAbyss, themeAbyssSpaced, themeDark, themeDracula, themeLight, themeLightSpaced, themeReplit, themeVisualStudio, toDockviewDragInteraction, toTarget };
